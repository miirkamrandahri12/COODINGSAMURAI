...
class Task {
    ...
    // Constructor for initialize task attributes
...
public class TasK_Tracker {
    ...
    // Method for display the main menu and handle user input
    private static void displayMenu() {
        ...
        do {
            ...
            sc.nextLine(); // print newline character
            ...
            switch (op) {
                case 1:
                    ...
                    break;
                case 2:
                    TaskAsComplete(); // Mark a task as complete
                    break;
                case 3:
                ...
                case 5:
                    ...
                    break;
                default:
                    System.out.println("Invalid choice! Please Select correct choice..."); // Handle invalid input
            }
        } while (op != 5); // Continue until user chooses to exit
    }
    ...
    private static void TaskAsComplete() {
